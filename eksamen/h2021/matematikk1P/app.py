...
UNDERTITTEL = "Matematikk 1P høst 2021"
titler = ["Oppgave 7"]
imports = ["oppgave7"]
innledninger = [[Markup("<p>Denne webappen løser oppgave 7 fra <a href='https://www.matematikk.net/res/eksamen/LK20/Eksempelsett_1P_H21.pdf'>Eksempeleksamen i Matematikk 1P høsten 2021 (Fagfornyelsen)</a>. Oppgaven handler om å lage et enkelt fakturasystem for takeaway.  Jeg har laget en webapp med den samme funksjonaliteten som regnearket i oppgaveteksten.</p>"),
                 Markup("<p>Jeg har også laget en forklaring på hvordan jeg laget webappen: <a href='https://magdalon.wordpress.com/2023/04/26/eksempeleksamen-1p-host-2021-oppgave-7-webapp/'>Eksamen 1P høst 2021: Oppgave 7 – webapp - Magdalons syn på verden</a></p>")]
                ]
moduler = []
